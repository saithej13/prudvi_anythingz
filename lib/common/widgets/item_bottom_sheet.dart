...
import 'package:anythingz/common/widgets/custom_tool_tip_widget.dart';
...
import 'package:anythingz/common/widgets/confirmation_dialog.dart';
...
import 'package:anythingz/common/widgets/discount_tag.dart';
import 'package:anythingz/common/widgets/quantity_button.dart';
import 'package:anythingz/common/widgets/rating_bar.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ItemController>(builder: (itemController) {
        ...
        //COMMENTED BY SAITEJA ON 20NOV2025
        if(variationPrice>0){
                    ...
                    Builder(
                      builder: (context) {
                       ...
                       // double withAddonCost = cost! + addonsCost;
                        double itemTotal = price! * itemController.quantity!;
                        double addonTotal = addonsCost > 0 ? addonsCost * itemController.quantity! : 0;

                        // Apply discount on (item + addon)
                              ...
                              return CustomButton(
                                ...
                                onPressed: (Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! && stock! <= 0) ? null : () async {
                                  ...
                                  if(invalid != null) {
                                    ...
                                    double actualPrice = variationPrice > 0 ? variationPrice : price!;
                                    double itemTotal = actualPrice * itemController.quantity!;
                                    double addonTotal = addonsCost > 0 ? addonsCost * itemController.quantity! : 0;
                                    double originalTotal = itemTotal + addonTotal;

                                    double finalTotal = PriceConverter.convertWithDiscount(
                                      originalTotal,
                                      discount,
                                      discountType,
                                    ) ?? 0;
...
// 🌟 UPDATE CART CONTROLLER VALUES (UI uses these)
//                                     cartController.itemPrice = itemTotal;
//                                     cartController.variationPrice = variationPrice;
//                                     cartController.addOns = addonTotal;
//                                     cartController.itemDiscountPrice = discountAmount;
                                    ...
                                    CartModel cartModel = CartModel(
                                        null,
                                        actualPrice,           // correct item price (variation or base)
                                        finalTotal,            // correct final price with addon & discount
                                        variation != null ? [variation] : [],
                                        itemController.selectedVariations,
                                        discountAmount,        // correct discount amount
