...
import 'package:anythingz/features/auth/screens/new_user_setup_screen.dart';
import 'package:anythingz/features/brands/screens/brands_product_screen.dart';
import 'package:anythingz/features/brands/screens/brands_screen.dart';
import 'package:anythingz/features/business/screens/subscription_payment_screen.dart';
import 'package:anythingz/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:anythingz/features/chat/domain/models/order_chat_model.dart';
import 'package:anythingz/features/loyalty/screens/loyalty_screen.dart';
import 'package:anythingz/features/profile/domain/models/update_user_model.dart';
import 'package:anythingz/features/refer_and_earn/screens/refer_and_earn_screen.dart';
...
import 'package:anythingz/features/checkout/domain/models/place_order_body_model.dart';
...
import 'package:anythingz/features/chat/domain/models/conversation_model.dart';
import 'package:anythingz/features/order/domain/models/order_model.dart';
import 'package:anythingz/features/item/domain/models/item_model.dart';
import 'package:anythingz/features/parcel/domain/models/parcel_category_model.dart';
import 'package:anythingz/features/store/domain/models/store_model.dart';
import 'package:anythingz/features/address/screens/add_address_screen.dart';
import 'package:anythingz/features/address/screens/address_screen.dart';
import 'package:anythingz/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:anythingz/features/auth/screens/sign_in_screen.dart';
import 'package:anythingz/features/auth/screens/sign_up_screen.dart';
import 'package:anythingz/features/auth/screens/store_registration_screen.dart';
import 'package:anythingz/features/category/screens/category_screen.dart';
import 'package:anythingz/features/location/screens/map_screen.dart';
import 'package:anythingz/features/store/screens/campaign_screen.dart';
...
import 'package:anythingz/common/widgets/image_viewer_screen.dart';
import 'package:anythingz/common/widgets/not_found.dart';
import 'package:anythingz/features/cart/screens/cart_screen.dart';
import 'package:anythingz/features/category/screens/category_item_screen.dart';
import 'package:anythingz/features/chat/screens/chat_screen.dart';
import 'package:anythingz/features/chat/screens/conversation_screen.dart';
import 'package:anythingz/features/checkout/screens/checkout_screen.dart';
import 'package:anythingz/features/payment/screens/offline_payment_screen.dart';
import 'package:anythingz/features/checkout/screens/order_successful_screen.dart';
import 'package:anythingz/features/payment/screens/payment_screen.dart';
import 'package:anythingz/features/payment/screens/payment_webview_screen.dart';
import 'package:anythingz/features/coupon/screens/coupon_screen.dart';
import 'package:anythingz/features/dashboard/screens/dashboard_screen.dart';
import 'package:anythingz/features/favourite/screens/favourite_screen.dart';
import 'package:anythingz/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:anythingz/features/item/screens/item_campaign_screen.dart';
import 'package:anythingz/features/item/screens/item_details_screen.dart';
import 'package:anythingz/features/item/screens/popular_item_screen.dart';
import 'package:anythingz/features/verification/screens/forget_pass_screen.dart';
import 'package:anythingz/features/verification/screens/new_pass_screen.dart';
import 'package:anythingz/features/verification/screens/verification_screen.dart';
import 'package:anythingz/features/html/screens/html_viewer_screen.dart';
import 'package:anythingz/features/interest/screens/interest_screen.dart';
import 'package:anythingz/features/language/screens/language_screen.dart';
import 'package:anythingz/features/location/screens/access_location_screen.dart';
import 'package:anythingz/features/location/screens/pick_map_screen.dart';
import 'package:anythingz/features/notification/screens/notification_screen.dart';
import 'package:anythingz/features/onboard/screens/onboarding_screen.dart';
import 'package:anythingz/features/order/screens/guest_track_order_screen.dart';
import 'package:anythingz/features/order/screens/order_details_screen.dart';
import 'package:anythingz/features/order/screens/order_screen.dart';
import 'package:anythingz/features/order/screens/order_tracking_screen.dart';
import 'package:anythingz/features/order/screens/refund_request_screen.dart';
import 'package:anythingz/features/parcel/screens/parcel_category_screen.dart';
import 'package:anythingz/features/parcel/screens/parcel_location_screen.dart';
import 'package:anythingz/features/parcel/screens/parcel_request_screen.dart';
import 'package:anythingz/features/profile/screens/profile_screen.dart';
import 'package:anythingz/features/profile/screens/update_profile_screen.dart';
import 'package:anythingz/features/store/screens/all_store_screen.dart';
import 'package:anythingz/features/store/screens/store_item_search_screen.dart';
import 'package:anythingz/features/store/screens/store_screen.dart';
import 'package:anythingz/features/review/screens/review_screen.dart';
import 'package:anythingz/features/search/screens/search_screen.dart';
import 'package:anythingz/features/splash/screens/splash_screen.dart';
import 'package:anythingz/features/support/screens/support_screen.dart';
import 'package:anythingz/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:anythingz/features/wallet/screens/wallet_screen.dart';
...
class RouteHelper {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: RouteHelper.notification,
      page: () => getRoute(NotificationScreen(
        fromNotification: Get.parameters['from'] == 'true',
        notificationId: int.tryParse(Get.parameters['id'] ?? ''),
      )),
    ),
    ...
    // GetPage(name: taxiOrderPage, page: () => getRoute(const TaxiOrderDetailsScreen(isOrderScreen: true,))),
...
//
//     // ? Version / Maintenance / Location checks (original logic)
//     final bool needUpdate =
//         AppConstants.appVersion < minimumVersion! && !GetPlatform.isWeb;
...
//     }
//     // ? NEW: Handle Notification ? StoreScreen redirect
//     if (Get.currentRoute == RouteHelper.notification) {
//       final notificationController = Get.find<NotificationController>();
//
// // Try from Get parameters first
//       final notificationId = int.tryParse(Get.parameters['id'] ?? '');
//       final notification = notificationController.notificationList
//           ?.firstWhereOrNull((n) => n.id == notificationId);
//
//       // ? Check for store_id
//       if (notification != null &&
//           notification.store_id != null &&
//           notification.store_id!.toString().isNotEmpty) {
//         final storeId = int.tryParse(notification.store_id.toString());
//         if (storeId != null) {
...
//               }
//
//               // 3?? If not found, fetch asynchronously
...
//           }
//
//           // Run asynchronously to prevent build-time navigation
//           Future.microtask(() async {
//             try {
//               final store = await findStoreById(storeId);
//               if (store != null) {
//                 Get.offAll(() =>
//                     StoreScreen(store: store, fromModule: false)); // ? Open Store
//               } else {
//                 Get.offAll(() =>
//                     NotificationScreen(fromNotification: true)); // fallback
//               }
//             } catch (e) {
...
//           });
//
//           // Return empty widget while async navigation happens
//           return const SizedBox.shrink();
//         }
//       }
//     }
//
//     // ? Default: Return the intended route
//     return navigateTo;
//   }
