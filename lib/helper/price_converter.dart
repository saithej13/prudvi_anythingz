...
class PriceConverter {
  ...
  static double? convertWithDiscountNew2(double? price, double? discount, String? discountType, {bool isFoodVariation = false}) {
    return price;
  }



  static double? convertWithDiscountNew(double? price, double? discount, String? discountType, {bool isFoodVariation = false}) {
    if(discountType == 'amount' && !isFoodVariation) {
      price =  discount!;
    }else if(discountType == 'percent') {
