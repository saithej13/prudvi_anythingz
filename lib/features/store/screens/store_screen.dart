...
import 'package:anythingz/common/widgets/item_widget.dart';
import 'package:anythingz/common/widgets/menu_drawer.dart';
import 'package:anythingz/common/widgets/paginated_list_view.dart';
import 'package:anythingz/common/widgets/veg_filter_widget.dart';
import 'package:anythingz/common/widgets/web_item_view.dart';
import 'package:anythingz/common/widgets/web_item_widget.dart';
import 'package:anythingz/common/widgets/web_menu_bar.dart';
import 'package:anythingz/features/checkout/screens/checkout_screen.dart';
import 'package:anythingz/features/search/widgets/custom_check_box_widget.dart';
import 'package:anythingz/features/store/widgets/customizable_space_bar_widget.dart';
import 'package:anythingz/features/store/widgets/store_banner_widget.dart';
import 'package:anythingz/features/store/widgets/store_description_view_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:anythingz/features/store/widgets/store_details_screen_shimmer_widget.dart';
            ...
            children: [
              ...
              GetBuilder<StoreController>(
                builder: (storeController) {
                  final categoryList = storeController.categoryList;
                  final categoryIndex = storeController.categoryIndex;
                  ...
                  return FloatingActionButton.extended(
                    onPressed: () {}, // menu handled inside PopupMenuButton
                    backgroundColor: Theme.of(context).primaryColor,
                    label: PopupMenuButton<int>(
                      ...
                      itemBuilder: (context) {
                        return List.generate(
                          ...
                          (index) => PopupMenuItem<int>(
                            value: index,
                            child: Text(
                              categoryList[index].name ?? "Unnamed",
                        ...
                        children: [
                          Text(
                            (categoryIndex >= 0 &&
                                ...
                                ? (categoryList[categoryIndex].name ?? "Select")
                                : "Select",
