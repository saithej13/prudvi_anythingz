...
class Store {
  ...
  double? maximum_cod_order_amount;
  List<int>? ratings;
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    maximum_cod_order_amount = json['maximum_cod_order_amount']?.toDouble() ?? 0;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['maximum_cod_order_amount'] = maximum_cod_order_amount;
