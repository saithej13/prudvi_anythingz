  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      ...
      Container(
        ...
        width: 30,
        child: Text('${ratingPercent.toStringAsFixed(0)}%', style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color?.withOpacity(0.5))),
      ),
