...
import 'package:anythingz/features/auth/widgets/business/base_card_widget.dart';
import 'package:anythingz/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:anythingz/features/auth/widgets/module_view_widget.dart';
import 'package:anythingz/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:anythingz/features/business/widgets/package_card_widget.dart';
...
import 'package:anythingz/common/models/translation.dart';
...
import 'package:anythingz/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:anythingz/features/auth/widgets/pass_view_widget.dart';
import 'package:anythingz/features/auth/widgets/select_location_view_widget.dart';
import 'package:anythingz/helper/responsive_helper.dart';
import 'package:anythingz/helper/validate_check.dart';
...
import 'package:anythingz/common/widgets/custom_text_field.dart';
                              ...
                              Row(children: [
                                ...
                                Expanded(flex: 4,
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(children: [
                                      Text('vendor_logo'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.7))),
                                ...
                                Expanded(flex: 6,
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(children: [
                                      Text('vendor_cover'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.7))),
                          ...
                          storeRegController.packageModel != null ? SizedBox(
                            ...
                            child: storeRegController.packageModel!.packages!.isNotEmpty ? Swiper(
                              ...
                              onIndexChanged: (index) {
                                ...
                                children: [
                                  Image.asset(Images.no_image_new, height: 150),
                                  const SizedBox(height: Dimensions.paddingSizeLarge),
