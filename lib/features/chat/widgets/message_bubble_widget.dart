...
import 'package:anythingz/features/chat/widgets/image_file_view_widget.dart';
...
import 'package:anythingz/features/chat/domain/models/chat_model.dart';
            ...
            Flexible(
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                (message.message != null && message.message!.isNotEmpty) ? Flexible(
                  child: Container(
                    decoration: BoxDecoration(
                      color: Get.isDarkMode ? Theme.of(context).primaryColor.withOpacity(0.2) : const Color(0xffE8EEFA),
