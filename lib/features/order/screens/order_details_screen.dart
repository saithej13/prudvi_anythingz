...
import 'package:anythingz/features/order/domain/models/order_details_model.dart';
...
import 'package:anythingz/common/widgets/custom_dialog.dart';
...
import 'package:anythingz/features/checkout/widgets/offline_success_dialog.dart';
import 'package:anythingz/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:anythingz/features/order/widgets/order_calcuation_widget.dart';
import 'package:anythingz/features/order/widgets/order_info_widget.dart';
import 'package:anythingz/features/review/screens/rate_review_screen.dart';
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          // if(addOns>0){
          //   subTotal=  addOns;
          //   total =  addOns - discount + (taxIncluded ? 0 : tax) + deliveryCharge - couponDiscount + dmTips + additionalCharge + extraPackagingCharge - referrerBonusAmount;
          // }
          // else{
          //   subTotal = itemsPrice ;
          //   total = itemsPrice - discount + (taxIncluded ? 0 : tax) + deliveryCharge - couponDiscount + dmTips + additionalCharge + extraPackagingCharge - referrerBonusAmount;
          // }
