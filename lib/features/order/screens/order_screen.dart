...
import 'package:anythingz/features/rental_module/rental_order/widgets/trip_order_view_widget.dart';
...
import 'package:anythingz/features/order/widgets/guest_track_order_input_view_widget.dart';
import 'package:anythingz/features/order/widgets/order_view_widget.dart';
              ...
              children: [
                ...
                haveTaxiModule && !ResponsiveHelper.isDesktop(context) ? Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: Theme.of(context).disabledColor.withOpacity(0.1), blurRadius: 5, offset: const Offset(0, 10))],
                  ),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              child: CustomInkWell(
                                ...
                                child: Text(type[index].tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: selected ? Colors.white : Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.7))),
                              ),
                            );
                          }),
                    ),
