...
import 'package:anythingz/features/home/widgets/category_pop_up.dart';
...
class CategoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SplashController>(builder: (splashController) {
      ...
      //       ? const SizedBox()
      //       : isPharmacy ? PharmacyCategoryView(categoryController: categoryController)
      //       : isFood
      //       ? FoodCategoryView(categoryController: categoryController)
      //       : Column(
      //     children: [
      //       SizedBox(
      //         height: 180, // ✅ enough space for 2 rows + text
      ...
      //           ),
      //
      //           /// ✅ KEY FIX: fixed item height system
      //           gridDelegate:
      //           const SliverGridDelegateWithFixedCrossAxisCount(
      //             crossAxisCount: 2, // 2 rows
      //             mainAxisExtent: 85, // ✅ FIX: prevents overflow completely
      //             crossAxisSpacing: 10,
      //             mainAxisSpacing: 10,
      //           ),
      //
      ...
      //                         radius: 26,
      //                         backgroundImage:
      //                         NetworkImage(category.imageFullUrl!),
            ...
            SizedBox(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      if (index == 9 && categories.length > 10) {
                        Get.toNamed(RouteHelper.getCategoryRoute());
                      } else {
                        Get.toNamed(
                          RouteHelper.getCategoryItemRoute(
          ...
          children: [
            SizedBox(
              ...
              child: categoryController.categoryList != null
                ...
                /// ✅ FIX: stable layout system
                gridDelegate:
                const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2, // 2 rows
                  mainAxisExtent: 95, // 🔥 FIX: prevents overflow
                  mainAxisSpacing: 8,
                  crossAxisSpacing: 8,
                ),
                      ...
                      children: [
                        ...
                        Stack(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              radius: 26,
                              backgroundImage: (category.imageFullUrl == null ||
                                  category.imageFullUrl!.isEmpty)
                                  ? null
                                  : NetworkImage(category.imageFullUrl!),
                              backgroundColor: Colors.grey[200],
                            ),
                        ...
                        /// 🏷 TEXT (NO Flexible → FIXED HEIGHT)
                        SizedBox(
                          height: 22, // 🔥 prevents overflow
                          child: Text(
                            (index == 11 &&
                                categoryController.categoryList!.length >
                                    12)
